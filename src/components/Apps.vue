<template>
  <div id="apps">
    <div id="apps-container" class="apps-container" data-intro="Retrouvez également les applications les plus utiles dans cette section" data-title="Applications" data-step="6">
