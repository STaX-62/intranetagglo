  ...
  <div class="news news-customcolor" v-bind:style="'--news-color: ' + newscolor">
    <div class="news-textbox">
      ...
      <div class="news-img-container">
        <b-carousel class="news-img" v-model="slide" v-if="photoMultiple && newfocus != ''" :interval="8000" no-animation controls indicators style="text-shadow: 1px 1px 2px #333;display:block"
